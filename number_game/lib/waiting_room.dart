...
class WaitingRoomState extends State<WaitingRoom> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("待機部屋"), automaticallyImplyLeading: false),
        body: Container(
                ...
                if (snapshot.hasData && snapshot.data["event"] == "start") {
                  ...
                  Timer(Duration(milliseconds: 100), () {
                    ...
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => GamePage(userID, userList.length,
                            snapshot.data["turns"], userList)));
                  });
                }
                return Column(
                  ...
                  children: [
                    ...
                    ButtonTheme(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            socket
                                .emit('leave', [widget.roomID, widget.userID]);
